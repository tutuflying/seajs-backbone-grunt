define("apps/test/1.0.0/view/app-debug", [ "$-debug", "underscore-debug", "mustache-debug", "backbone-debug", "../collection/test-debug", "../model/test-debug", "../view/test-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    ...
    var testView = require("../view/test-debug");
